...
import com.angjiax.angjiaxaigent.mapper.UserMapper;
...
import static com.angjiax.angjiaxaigent.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public QueryWrapper<User> getQueryWrapper(UserQueryRequest userQueryRequest) {
        ...
        Integer vip_level = userQueryRequest.getVip_level();
        ...
        queryWrapper.eq(ObjUtil.isNotNull(vip_level), "vip_level", vip_level);
        queryWrapper.eq(ObjUtil.isNotNull(points), "points", points);
